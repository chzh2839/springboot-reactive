...
`ItemController`는 다음과 같은 응답을 반환합니다.

include::{snippets}/getItems/response-body.adoc[]

HTTPie를 사용하시나요? 다음 명령을 실행해보세요.

include::{snippets}/getItems/httpie-request.adoc[]
...
include::{snippets}/getItem/httpie-request.adoc[]
...
include::{snippets}/getItem/response-body.adoc[]

===== 링크

include::{snippets}/getItem-hypermedia/links.adoc[]